...
#ifndef LIVE_ACTIVITIES_SWIFT_H
#define LIVE_ACTIVITIES_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="live_activities",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
@class UIApplication;
@class NSURL;
SWIFT_CLASS("_TtC15live_activities25SwiftLiveActivitiesPlugin")
@interface SwiftLiveActivitiesPlugin : NSObject <FlutterPlugin, FlutterStreamHandler>
